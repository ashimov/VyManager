...
interface EditExtCommunityListModalProps {
  open: boolean;
...
export function EditExtCommunityListModal({
  open,
  onOpenChange,
  onSuccess,
  extcommunityList,
  ...
  useEffect(() => {
    if (open && extcommunityList) {
      setDescription(extcommunityList.description || "");
      setError(null);
    }
  }, [open, extcommunityList]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      await extcommunityListService.updateExtCommunityList(
